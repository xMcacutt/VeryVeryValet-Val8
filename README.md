# Very Very Valet - Val8

## What does this do?
This mod adds 8 player support to the story mode of Very Very Valet.
Simply connect more than four controllers on the Valet Select screen.
...
7. Download the latest release of this mod from the releases page
8. Extract the mod zip into the BepinEx/plugins folder in your game directory
9. Launch the game
10. Pick up cars
11. Park them
12. Cry